...
//------------------------------------------------------------------------------------------
export class GameEditorController extends XGameController {
...
//------------------------------------------------------------------------------------------
	public afterSetup (__params:Array<any> = null):XGameObject {
		...
		this.m_terrainNum = __params[1];
		this.m_layersXMLString = __params[2];
		this.m_terrainXMLString = __params[3];
		this.m_levelData = __params[4];
		this.m_score = __params[5];
		...
		if (this.m_layersXMLString == null || this.m_terrainXMLString == null) {
			...
			console.log (": GameEditorController: xml: ", this.m_layersXMLString, this.m_terrainXMLString);
