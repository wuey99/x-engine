...
import { GUID } from '../utils/GUID';
	...
	//------------------------------------------------------------------------------------------
	class FlockLeader extends EnemyX {
		...
		public createFollower (__dx:number, __dy:number):void {
			var __followerObject:FlockFollower = cast xxx.getXLogicManager ().initXLogicObject (
				// parent
				G.appX.getLevelObject (),
				// logicObject
				XType.createInstance (followerClass ()),
				// item, layer, depth
