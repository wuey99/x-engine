...
//------------------------------------------------------------------------------------------
	...
	public drawProgressBarOutline ():void {
		var __x:number = (this.m_XApp.getScreenWidth () - this.m_progressBarWidth) / 2;
		var __y:number = (this.m_XApp.getScreenHeight () - this.m_progressBarHeight) / 2;

		this.m_graphics.lineStyle (6, LoadingScreen.PROGRESSBAR_COLOR);
		this.m_graphics.moveTo (__x, __y);
		this.m_graphics.lineTo (__x + this.m_progressBarWidth, __y);
		this.m_graphics.lineTo (__x + this.m_progressBarWidth, __y + this.m_progressBarHeight);
		this.m_graphics.lineTo (__x, __y + this.m_progressBarHeight);
		this.m_graphics.lineTo (__x, __y);
	}
	...
	public updateProgressBar (__percentage:number):void {
		...
		this.m_graphics.beginFill (LoadingScreen.PROGRESSBAR_COLOR);
		this.m_graphics.drawRect (__x, __y, this.m_progressBarWidth * __percentage, this.m_progressBarHeight);
		this.m_graphics.endFill ();

		return;

		this.m_graphics.beginFill (LoadingScreen.BG_COLOR);
		this.m_graphics.drawRect (__x + this.m_progressBarWidth * __percentage, __y, this.m_progressBarWidth * (1.0  -__percentage), this.m_progressBarHeight);
		this.m_graphics.endFill ();
	}
